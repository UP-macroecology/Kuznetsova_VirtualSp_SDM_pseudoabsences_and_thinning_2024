...
#SBATCH --job-name=replicates_job.sh
#SBATCH --mail-type=ALL
#SBATCH --mail-user=kuznetsov1@uni-potsdam.de
#SBATCH --output=replicates_output.log  # Standard output
#SBATCH --error=replicates_error.log    # Standard error
...
# Run the R script
Rscript /import/ecoc9/data-zurell/kuznetsova/pseudoabsences/scripts/5_Create_data_replicates.R